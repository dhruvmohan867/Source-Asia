...
function SeatSelectionContent() {
  ...
  // ============================================================
  // Zustand Selectors (IMPORTANT FIX)
  // ============================================================
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <Link
          href={`/flights?origin=${selectedFlight.origin}&destination=${selectedFlight.destination}&date=${selectedFlight.departure_time.split('T')[0]}&passengers=${passengers}`}
